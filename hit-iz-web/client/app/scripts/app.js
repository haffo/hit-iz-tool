...
//                console.log('detected msg with text: ' + msg.text);
  ...
  $rootScope.isDomainsManagementSupported = function () {
     return $rootScope.getAppInfo().options && ($rootScope.getAppInfo().options['DOMAIN_MANAGEMENT_SUPPORTED'] === "true" || $rootScope.getAppInfo().options['DOMAIN_MANAGEMENT_SUPPORTED'] === true) || userInfoService.isAdmin();
  };
