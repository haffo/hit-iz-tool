...
angular.module('connectivity').factory('Connectivity',
    ['$rootScope', '$http', '$q', 'ConnectivityPart', 'Logger', 'Endpoint', '', 'StorageService', function ($rootScope, $http, $q, ConnectivityPart, Logger, Endpoint, SOAPConnectivityUser, StorageService) {

        var initUser = function () {
            var user = new SOAPConnectivityUser();
