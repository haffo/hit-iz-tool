...
angular.module('isolated').factory('IsolatedSystem',
    ['$http', '$q', 'Message', 'ValidationSettings', 'Tree', '$rootScope', 'Logger','StorageService','Transport',function ($http, $q, Message, ValidationSettings,Tree,$rootScope,Logger,StorageService,Transport) {
