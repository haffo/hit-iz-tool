...
public class SoapController {
	...
	public String download(@PathVariable String format,
		...
		try {
			...
			if (xmlReport == null) {
				throw new SoapValidationReportException(
						"No xml report found in the request");
			}
			...
			if ("HTML".equalsIgnoreCase(format)) {
				...
				throw new SoapValidationReportException(
						"Unsupported Message Validation Report format "
								+ format);
			}
			...
			throw new SoapValidationReportException(
					"Cannot download the validation report");
		}
		return null;
	}
	...
	public Callable<Map<String, String>> generate(
		...
		return new Callable<Map<String, String>>() {
			...
			public Map<String, String> call() throws Exception {
				...
				if ("HTML".equalsIgnoreCase(format)) {
					...
					throw new SoapValidationReportException(
							"Unsupported Soap Validation Report format "
									+ format);
				}
			}
		};
	...
	public String download(@RequestParam("envelope") String envelope,
			HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			throw new MessageException("Cannot download the content "
					+ e.getMessage());
		}
		return null;
	}
