...
public class Er7MessageController {
  ...
  static final Logger logger = LoggerFactory.getLogger(Er7MessageController.class);
  ...
  public String download(@RequestParam("er7Message") String er7Message, HttpServletRequest request,
  ...
  public Map<String, String> upload(@RequestPart("file") MultipartFile part)
    ...
    try {
      ...
      try {
        ...
        map.put("content", "Sorry, file content is not an er7 message content");
      }
      return map;
    } catch (IOException e) {
