...
public class CDCSoapValidation {
  ...
  private ArrayList<MessageFailureV3> verifySubmitSingleMessageRequest(String soapMessage,
      String phase) {
  ...
  private ArrayList<MessageFailureV3> verifyConnectivityResponse(String soapMessage,
    ...
    try {
      if (requestMessage != null) {
        ...
        String echoBack = eckoBackNode != null ? eckoBackNode.getTextContent() : null;
        Node returnNode =
            ConnectivityUtil
                .findNode(
                    soapMessage,
                    "//*[local-name()='Envelope']/*[local-name()='Body']/*[local-name()='connectivityTestResponse']/*[local-name()='return']");
        String returnedValue = returnNode != null ? returnNode.getTextContent() : null;
        if (returnNode == null || returnedValue == null) {
          ...
          mf.setFailureSeverity(ErrorSeverityConstants.NORMAL);
          mf.setAssertionResult(AssertionResultConstants.ERROR);
          mf.setDescription("The returned value '" + returnedValue + "' does not contain '"
              + echoBack + "'");
  ...
  private ArrayList<MessageFailureV3> verifySubmitSingleMessageResponse(String soapMessage) {
    ...
    try {
      ...
      if (content != null && !"".equals(content)) {
        ...
        String returnContent = content.getTextContent();
        String cdataStart = "<![CDATA[";
        String cdataEnd = "]]>";
  ...
  public gov.nist.healthcare.core.validation.soap.SoapValidationResult validate(
      SoapMessage soapMessage, InputStream schematron, String... options) throws XmlException {
    ...
    return new gov.nist.healthcare.core.validation.soap.SoapValidationResult(soapMessage,
        soapFailures);
  }
  ...
  private String normalizeErrPath(String targetPath) {
    ...
    if (targetPath.equals("/Envelope/Body/connectivityTest")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope/Body/connectivityTest\\E",
    ...
    if (targetPath.equals("/Envelope/Body/connectivityTestResponse")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope/Body/connectivityTestResponse\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/connectivityTest[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/connectivityTest[1]\\E",
              "/a:Envelope/a:Body/b:connectivityTest");
    }
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/connectivityTest[1]/echoBack[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/connectivityTest[1]/echoBack[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/connectivityTestResponse[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/connectivityTestResponse[1]\\E",
              "/a:Envelope/a:Body/b:connectivityTestResponse");
    }
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/connectivityTestResponse[1]/return[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/connectivityTestResponse[1]/return[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/submitSingleMessage[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/submitSingleMessage[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/submitSingleMessage[1]/username[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/submitSingleMessage[1]/username[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/submitSingleMessage[1]/password[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/submitSingleMessage[1]/password[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/submitSingleMessage[1]/facilityID[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/submitSingleMessage[1]/facilityID[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/submitSingleMessage[1]/hl7Message[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/submitSingleMessage[1]/hl7Message[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/submitSingleMessageResponse[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/submitSingleMessageResponse[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/Fault[1]")) {
      tp1 =
          targetPath
              .replaceAll("\\Q/Envelope[1]/Body[1]/Fault[1]\\E", "/a:Envelope/a:Body/a:Fault");
    }

    // Envelope/Body/Fault/Code
    if (targetPath.equals("/Envelope[1]/Body[1]/Fault[1]/Code[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/Fault[1]/Code[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/Fault[1]/Code[1]/Value[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/Fault[1]/Code[1]/Value[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/Fault[1]/Reason[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/Fault[1]/Reason[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/Fault[1]/Detail[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/Fault[1]/Detail[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/Fault[1]/Detail[1]/SecurityFault[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/Fault[1]/Detail[1]/SecurityFault[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/Fault[1]/Detail[1]/fault[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/Fault[1]/Detail[1]/fault[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/Fault[1]/Detail[1]/fault[1]/Code[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/Fault[1]/Detail[1]/fault[1]/Code[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/Fault[1]/Detail[1]/fault[1]/Reason[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/Fault[1]/Detail[1]/fault[1]/Reason[1]\\E",
    ...
    if (targetPath.equals("/Envelope[1]/Body[1]/Fault[1]/Detail[1]/fault[1]/Detail[1]")) {
      tp1 =
          targetPath.replaceAll("\\Q/Envelope[1]/Body[1]/Fault[1]/Detail[1]/fault[1]/Detail[1]\\E",
