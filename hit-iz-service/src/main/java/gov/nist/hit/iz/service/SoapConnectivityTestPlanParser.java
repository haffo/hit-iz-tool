...
public class SoapConnectivityTestPlanParser extends TestPlanParser {
	...
	public List<SoapConnectivityTestPlan> create()
		...
		testCase.setInstructionsText(FileUtil.getContent(testCasePath
				+ "/instructions.txt"));
		testCase.setTestDataSpecificationImage(FileUtil
				.getByteArray(testCasePath + "/testDataSpecification.png"));
		...
		context.setRequestContentImage(FileUtil.getByteArray(testCasePath
				+ "/content.png"));
		context.setResponseContentImage(FileUtil.getByteArray(testCasePath
